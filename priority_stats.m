...
load('/Volumes/hyper/experiments/Grace/TMS_Priority/subj04/l_ips2_II/ii_stats.mat');
...
filename = sprintf('/Volumes/hyper/experiments/Grace/TMS_Priority/subj04/l_ips2_II/TASK/%s.mat',runs{jj});
...
if cond == 'hi';
    run_num_hi_ind = find(task_priority_identity == 31); % hi priority identity, should occur 24x/ run
    numtrials_givenpriority = run_num_hi_ind;
else
    run_num_lo_ind = find(task_priority_identity == 32); %lo priority identity, should occur 12x /run
