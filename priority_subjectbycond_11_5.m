...
%% plotting loop - PRIMARY 

 for ii= 1:4
figure(ii);
subplot(1,3,1)
hold on;
%plot([1,2], [demeand_pri_hi_left_cond_one(ii)  demeand_pri_lo_left_cond_one(ii)],'o-','color', c1,'markersize',10,'MarkerEdgeColor', c1) %ipsi
errorbar([demeand_pri_hi_left_cond_one(ii) demeand_pri_lo_left_cond_one(ii)] , [diff_vect(1) diff_vect(1)] ,'o-','color', c1,'markersize',10,'MarkerEdgeColor', c1)%'.')
%plot([1,2], [demeand_pri_hi_right_cond_one(ii)  demeand_pri_lo_right_cond_one(ii)],'o--','color', c1,'markersize', 10,'MarkerEdgeColor', c1,'MarkerFaceColor', c1) %contra
set(gca, 'xtick', [1 2])
set(gca, 'xticklabel',  {'High Priority', 'Low Priority'})
set(gca, 'fontsize', 14)
hold on; 
errorbar([demeand_pri_hi_right_cond_one(ii) demeand_pri_lo_right_cond_one(ii)], [diff_vect(2) diff_vect(2)] ,'o--','color', c1,'markersize', 10,'MarkerEdgeColor', c1,'MarkerFaceColor', c1)%'.')
legend('No TMS ipsi', 'No TMS contra', 'sPCS ipsi','sPCS contra')


ylim([-1 1])
subplot(1,3,2)
plot([1,2], [demeand_pri_hi_left_cond_two(ii)  demeand_pri_lo_left_cond_two(ii)],'o-','color', c13,'markersize',10,'MarkerEdgeColor', c13) %ipsi
hold on;
errorbar([demeand_pri_hi_left_cond_two(ii) demeand_pri_lo_left_cond_two(ii)] , [diff_vect(3) diff_vect(3)] ,'.')
plot([1,2], [demeand_pri_hi_right_cond_two(ii)  demeand_pri_lo_right_cond_two(ii)],'o--','color', c13,'markersize', 10,'MarkerEdgeColor', c13,'MarkerFaceColor', c13) %contra
errorbar([demeand_pri_hi_right_cond_two(ii) demeand_pri_lo_right_cond_two(ii)] , [diff_vect(4) diff_vect(4)] ,'.')
ylim([-1 1])
subplot(1,3,3)
plot([1,2], [demeand_pri_hi_left_cond_three(ii)  demeand_pri_lo_left_cond_three(ii)],'o-','color', c5,'markersize',10,'MarkerEdgeColor', c5) %ipsi
hold on;
errorbar([demeand_pri_hi_left_cond_three(ii) demeand_pri_lo_left_cond_three(ii)] , [diff_vect(5) diff_vect(5)] ,'.')
plot([1,2], [demeand_pri_hi_right_cond_three(ii)  demeand_pri_lo_right_cond_three(ii)],'o--','color', c5,'markersize', 10,'MarkerEdgeColor', c5,'MarkerFaceColor', c5) %contra
errorbar([demeand_pri_hi_right_cond_three(ii) demeand_pri_lo_right_cond_three(ii)] , [diff_vect(6) diff_vect(6)] ,'.')
ylim([-1 1])
